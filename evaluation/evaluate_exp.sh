...
#base_path="D:/Stuff/BTthuchanh/AI/AC-SUM-GAN/exp1"
#exp_name="sigma0.1"
#dataset_name="TVSum"
#eval_method='avg'
...
exp_path="$base_path/$dataset_name"  #change this path if you use different structure for your directories inside the experiment
