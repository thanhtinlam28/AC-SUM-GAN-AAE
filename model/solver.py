    ...
    def build(self):
        ...
        if self.config.mode == 'train':
            ...
            self.e_optimizer = optim.Adam(
                self.summarizer.auto_enc.e_lstm.parameters(),
                lr=self.config.lr)
            self.d_optimizer = optim.Adam(
                self.summarizer.auto_enc.d_lstm.parameters(),
                lr=self.config.lr)
        ...
        for epoch_i in trange(self.config.n_epochs, desc='Epoch', ncols=80):
            ...
            for batch in range(num_batches):
                ...
                for video in range(self.config.batch_size):
                    ...
                    h_mu, h_log_variance, generated_features = self.summarizer.auto_enc(weighted_features)
                ...
                torch.nn.utils.clip_grad_norm_(self.summarizer.auto_enc.e_lstm.parameters(), self.config.clip)
                ...
                torch.nn.utils.clip_grad_norm_(self.summarizer.auto_enc.d_lstm.parameters(), self.config.clip)
